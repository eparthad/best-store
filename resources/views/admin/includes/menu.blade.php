    ...
    <ul class="nav" id="side-menu">
        ...
        <li>
            ...
            <ul class="nav nav-second-level">
                <li>
                    <a href="{{ url('/user/manage-user') }}">Manage User</a>
                </li>
            </ul>
            <!-- /.nav-second-level -->
        </li>
        ...
        <li>
            ...
            <ul class="nav nav-second-level">
                ...
                <li>
                    <a href="{{ url('/manufacturer/manage-manufacturer') }}">Manage Manufacturer</a>
                </li>
            </ul>
            <!-- /.nav-second-level -->
        </li>
        ...
        <li>
            ...
            <ul class="nav nav-second-level">
                <li>
                    <a href="{{ url('/manage-order') }}"><i class="fa fa-table fa-fw"></i> Manage Orders</a>
                </li>
            </ul>
            <!-- /.nav-second-level -->
        </li>
