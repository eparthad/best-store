        ...
        <div class="container">
            <div class="col-md-3 products-left">
                ...
                <div class="men-position animated wow slideInUp" data-wow-delay=".5s">
                    <a href="single.html"><img src="{{ asset('frontEnd/images/29.jpg') }}" alt=" " class="img-responsive" /></a>
            ...
            <div class="col-md-9 single-right">
                <div class="col-md-6 single-right-left animated wow slideInUp" data-wow-delay=".5s">
                    <div class="flexslider">
                        <ul class="slides">
                            <li data-thumb="{{ asset($productDetails->productImage) }}">
                                <div class="thumb-image"> <img src="{{ asset($productDetails->productImage) }}" data-imagezoom="true" class="img-responsive"> </div>
                            </li>
                            <li data-thumb="{{ asset($productDetails->productImage) }}">
                                <div class="thumb-image"> <img src="{{ asset($productDetails->productImage) }}" data-imagezoom="true" class="img-responsive"> </div>
                            </li>
                ...
                <div class="col-md-6 single-right-left simpleCart_shelfItem animated wow slideInRight" data-wow-delay=".5s">
                    <h3>{{ $productDetails->productName }}</h3>
                    <h4><span class="item_price">TK. {{ $productDetails->productPrice }}</span></h4>
                    <div class="rating1">
                    ...
                    <div class="description">
                        ...
                        <p>{{ strip_tags($productDetails->productShortDescription) }}</p>
                    </div>
                    {!! Form::open(['url'=>'/add-to-cart/'.$productDetails->id, 'method'=>'POST','class'=>'form-horizontal']) !!}
                    ...
                    {{--<div class="occasional">--}}
                        ...
                        {{--<div class="clearfix"> </div>--}}
                    {{--</div>--}}
                    <button class="occasion-cart" type="submit">
                    ...
                    <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                        ...
                        <div id="myTabContent" class="tab-content">
                            <div role="tabpanel" class="tab-pane fade in active bootstrap-tab-text" id="home" aria-labelledby="home-tab">
                                ...
                                <p>{{ strip_tags($productDetails->productLongDescription) }}</p>
                            </div>
            ...
            <div class="new-collections-grids">
                <div class="col-md-3 new-collections-grid">
                    <div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".5s">
                        <div class="new-collections-grid1-image">
                            <a href="single.html" class="product-image"><img src="{{ asset('frontEnd/images/8.jpg') }}" alt=" " class="img-responsive"></a>
                ...
                <div class="col-md-6 new-collections-grid">
                    <div class="new-collections-grid1-sub">
                        <div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".6s">
                            <div class="new-collections-grid1-image">
                                <a href="single.html" class="product-image"><img src="{{ asset('frontEnd/images/6.jpg') }}" alt=" " class="img-responsive"></a>
                                <div class="new-collections-grid1-image-pos">
                                    <a href="single.html">Quick View</a>
                                </div>
                                <div class="new-collections-grid1-right">
                    ...
                    <div class="new-collections-grid1-sub">
                        <div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".7s">
                            <div class="new-collections-grid1-image">
                                <a href="single.html" class="product-image"><img src="{{ asset('frontEnd/images/9.jpg') }}" alt=" " class="img-responsive"></a>
                                <div class="new-collections-grid1-image-pos">
                                    <a href="single.html">Quick View</a>
                                </div>
                                <div class="new-collections-grid1-right">
                ...
                <div class="col-md-3 new-collections-grid">
                    <div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".8s">
                        <div class="new-collections-grid1-image">
                            <a href="single.html" class="product-image"><img src="{{ asset('frontEnd/images/11.jpg') }}" alt=" " class="img-responsive"></a>
                            <div class="new-collections-grid1-image-pos">
                                <a href="single.html">Quick View</a>
                            </div>
                            <div class="new-collections-grid1-right">
