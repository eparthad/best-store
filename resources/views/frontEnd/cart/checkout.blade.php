    ...
    <div class="register">
        <div class="container">
            ...
            <div class="login-form-grids">
                ...
                {{--</form>--}}
                {!! Form::open(['url'=>'/customer-login', 'method'=>'POST','class'=>'animated wow slideInUp','data-wow-delay'=>'.5s']) !!}
                {{--<form class="animated wow slideInUp" data-wow-delay=".5s">--}}
                    ...
                    <input type="password" name="password_again" placeholder="Password Confirmation" required=" " >
