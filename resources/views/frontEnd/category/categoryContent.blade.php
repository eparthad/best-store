            ...
            <div class="col-md-4 products-left">
                ...
                <div class="new-products animated wow slideInUp" data-wow-delay=".5s">
                    ...
                    <div class="new-products-grids">
                        ...
                        {{--@foreach($publishCategoryProduct as $product)--}}
                        <div class="new-products-grid">
                            <div class="new-products-grid-left">
                                <a href="single.html"><img src="{{ asset('frontEnd/images/6.jpg') }}" alt=" " class="img-responsive" /></a>
                            </div>
                        ...
                        <div class="new-products-grid">
                            <div class="new-products-grid-left">
                                <a href="single.html"><img src="{{ asset('frontEnd/images/26.jpg') }}" alt=" " class="img-responsive" /></a>
                            </div>
                            <div class="new-products-grid-right">
                        ...
                        <div class="new-products-grid">
                            <div class="new-products-grid-left">
                                <a href="single.html"><img src="{{ asset('frontEnd/images/11.jpg') }}" alt=" " class="img-responsive" /></a>
                            </div>
                            <div class="new-products-grid-right">
                ...
                <div class="men-position animated wow slideInUp" data-wow-delay=".5s">
                    <a href="single.html"><img src="{{ asset('frontEnd/images/27.jpg') }}" alt=" " class="img-responsive" /></a>
            ...
            <div class="col-md-8 products-right">
                ...
                <div class="products-right-grids-bottom">
                    ...
                    <h3 class="text-center text-default">
                        @if(!count($publishCategoryProduct) > 0)
                    ...
                    <div class="col-md-4 products-right-grids-bottom-grid">
                        <div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">
                            <div class="new-collections-grid1-image">
                                <a href="{{ url('/product-details/'.$product->id.'/'.$product->productName) }}" class="product-image"><img src="{{ asset($product->productImage) }}" alt=" " class="img-responsive"></a>
                                <div class="new-collections-grid1-image-pos products-right-grids-pos">
                                    <a href="{{ url('/product-details/'.$product->id.'/'.$product->productName) }}">Quick View</a>
                                </div>
                            </div>
                    ...
                    {{--<div class="col-md-4 products-right-grids-bottom-grid">--}}
                        {{--<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">--}}
                            {{--<div class="new-collections-grid1-image">--}}
                                {{--<a href="single.html" class="product-image"><img src="{{ asset('frontEnd/images/7.jpg') }}" alt=" " class="img-responsive"></a>--}}
                                {{--<div class="new-collections-grid1-image-pos products-right-grids-pos">--}}
                        ...
                        {{--<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">--}}
                            {{--<div class="new-collections-grid1-image">--}}
                                {{--<a href="single.html" class="product-image"><img src="{{ asset('frontEnd/images/22.jpg') }}" alt=" " class="img-responsive"></a>--}}
                                {{--<div class="new-collections-grid1-image-pos products-right-grids-pos">--}}
                                    {{--<a href="single.html">Quick View</a>--}}
                                {{--</div>--}}
                                {{--<div class="new-collections-grid1-right products-right-grids-pos-right">--}}
                        ...
                        {{--<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">--}}
                            {{--<div class="new-collections-grid1-image">--}}
                                {{--<a href="single.html" class="product-image"><img src="{{ asset('frontEnd/images/25.jpg') }}" alt=" " class="img-responsive"></a>--}}
                                {{--<div class="new-collections-grid1-image-pos products-right-grids-pos">--}}
                                    {{--<a href="single.html">Quick View</a>--}}
                                {{--</div>--}}
                                {{--<div class="new-collections-grid1-right products-right-grids-pos-right">--}}
                    ...
                    {{--<div class="col-md-4 products-right-grids-bottom-grid">--}}
                        {{--<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">--}}
                            {{--<div class="new-collections-grid1-image">--}}
                                {{--<a href="single.html" class="product-image"><img src="{{ asset('frontEnd/images/20.jpg') }}" alt=" " class="img-responsive"></a>--}}
                                {{--<div class="new-collections-grid1-image-pos products-right-grids-pos">--}}
                                    {{--<a href="single.html">Quick View</a>--}}
                                {{--</div>--}}
                                {{--<div class="new-collections-grid1-right products-right-grids-pos-right">--}}
                        ...
                        {{--<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">--}}
                            {{--<div class="new-collections-grid1-image">--}}
                                {{--<a href="single.html" class="product-image"><img src="{{ asset('frontEnd/images/23.jpg') }}" alt=" " class="img-responsive"></a>--}}
                                {{--<div class="new-collections-grid1-image-pos products-right-grids-pos">--}}
                                    {{--<a href="single.html">Quick View</a>--}}
                                {{--</div>--}}
                                {{--<div class="new-collections-grid1-right products-right-grids-pos-right">--}}
                        ...
                        {{--<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">--}}
                            {{--<div class="new-collections-grid1-image">--}}
                                {{--<a href="single.html" class="product-image"><img src="{{ asset('frontEnd/images/26.jpg') }}" alt=" " class="img-responsive"></a>--}}
                                {{--<div class="new-collections-grid1-image-pos products-right-grids-pos">--}}
                                    {{--<a href="single.html">Quick View</a>--}}
                                {{--</div>--}}
                                {{--<div class="new-collections-grid1-right products-right-grids-pos-right">--}}
